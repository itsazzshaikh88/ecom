...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
			<div class="container">
				<a class="navbar-brand d-inline-flex" href="index.html">
					...
					<span class="text-1000 fs-3 fw-bold ms-2 text-gradient">YourShop</span>
				</a>
				...
				<div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto gap-2">
						...
						<li class="nav-item border btn btn-sm btn-primary py-0">
		...
		<section class="py-5 overflow-hidden bg-primary" id="home">
			<div class="container">
				<div class="row flex-center">
					<div class="col-md-5 col-lg-6 order-0 order-md-1 mt-8 mt-md-0"><a class="img-landing-banner" href="#!"><img class="img-fluid" src="assets/images/food-banner.png" alt="hero-header" /></a></div>
					<div class="col-md-7 col-lg-6 py-8 d-flex align-items-center justify-content-center flex-column">
						<h1 class="display-1 fs-md-5 fs-lg-6 fs-xl-8 text-light">Freshness Delivered to Your Doorstep!</h1>
						<h1 class="text-800 mb-5 fs-4">Shop fresh fruits, vegetables, and delicious foods handpicked for your family.</h1>
			...
			<div class="container">
				<div class="row h-100 gx-2 mt-7">
					<div class="col-md-12 my-4">
						...
						<p>Fresh items and much more</p>
					</div>
				</div>
				<div class="row h-100 gx-2 justify-content-center" id="home-categories-container">
			...
			<div class="container">
				<div class="row h-100">
					<div class="col-lg-7 mx-auto text-center mb-6">
						<h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Featured Items</h5>
					</div>
				</div>
				<div class="row gx-2 justify-content-start" id="home-products-container">
				...
				<div class="row flex-center pb-3">
					...
					<div class="col-md-6 order-1">
						<p class="text-200 text-center text-md-end"> Made with&nbsp;
							...
							</svg>&nbsp;by&nbsp;<a class="text-200 fw-bold" href="#" target="_blank">Juveria Soft </a>
						</p>
					</div>
				</div>
			</div><!-- end of .container-->
	...
	<script>
		...
		const adminURL = "<?= base_url() ?>-inv";
	</script>

	<!-- Load User specified scripts from controllers  -->
	<?php
